...
class WxPayConf_pub
{
	...
	const APPID = 'wx6bede5ed94fd5cd2';//服务商的
	//受理商ID，身份标识
	const MCHID = '1406978502';//服务商的
	//商户支付密钥Key。审核通过后，在微信发送的邮件中查看
	const KEY = '1234567890founyafounya1234567890';//服务商的
	...
	const JS_API_CALL_URL = 'http://shop.founya.com/index.php/mobile/WxPay/pay';
	...
	const NOTIFY_URL = 'http://shop.founya.com/index.php/home/wxChat/notify';
