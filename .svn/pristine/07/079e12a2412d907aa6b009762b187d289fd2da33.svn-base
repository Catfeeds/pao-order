...
class TurnoverController extends CommonController{
	...
	public function index(){
        ...
        // 新增一个余额
		$totalAmout_whenToday = $totalAmount_isCashToday+$totalAmount_isAlipayToday+$totalAmount_isWeChatToday+$totalAmount_isRemainderToday;
		
		//当天的订单数
		$pay_type = array("in","0,1,2,4");
		$conditionSet = $this->getConditionSet_isTurnover($startTimeStamp,$endTimeStamp,$pay_type,$storeRange);
		...
		$totalAmount_whenMonth = $totalAmount_isCashMonth+$totalAmount_isAlipayMonth+$totalAmount_isWeChatMonth+$totalAmount_isRemainderMonth;
