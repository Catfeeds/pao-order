...
class WxPayConfig
{
	 ...
	 * @var string
	 */
	static $APPID = 'wx6bede5ed94fd5cd2';
	static $MCHID = '1406978502';
	static $KEY = '1234567890founyafounya1234567890';
//	static $APPSECRET = '14c17c03b92fbe64f1bd458561a0da08';
	static $SUB_MCHID = '';
...
//dump($wxpay_c);
WxPayConfig::$SUB_MCHID = $wxpay_c['wxpay_child_mchid'];           //公众帐号secert（仅JSAPI支付的时候需要配置， 登录公众平台，进入开发者中心可设置）
