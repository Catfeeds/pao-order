...
<body>
	...
	<form action="/index.php/Agent/Sale/exportExcel" id="search_form" method="post">
		<div class="sale-search-box">
			...
			<ul class="search-list clearfix">
				...
				<li class="item"><input type="radio" id="food_nameTag" name="sortType" value="2"><label for="food_nameTag">菜品：</label><input
	...
	<script src="/Public/js/Agent/sale_index.js"></script>
</body>
