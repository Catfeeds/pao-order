...
<body>
	<header class="home-header">
		<a href="/index.php/Vertical/Index/index">
		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-xs-6 forHere">
					<a href="/index.php/Vertical/Index/processRoute/process/select/order_type/1"><img src="/Public/images/restaurant.png"></a>
				</div>
				<div class="col-xs-6 goTo">
					<a href="/index.php/Vertical/Index/processRoute/process/select/order_type/2"><img src="/Public/images/take_out.png"></a>
				</div>
			</div>
		</div>
	</div>	
