	...
	$('#statistics').mouseover(function(){
		$('.statistics-list').stop().slideDown();
	});
	$('#statistics').mouseout(function(){
		$('.statistics-list').stop().slideUp(100);
	});

	$('.header ul>li').click(function() {
		$(this).addClass('active').siblings().removeClass('active');
	});
	$('#statistics2').mouseover(function(){
		$('.statistics-list2').stop().slideDown();
	});
	$('#statistics2').mouseout(function(){
		$('.statistics-list2').stop().slideUp(100);
	});
	function loginout(){
